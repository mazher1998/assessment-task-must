...
<!--		</div>-->
<!--	</footer>-->
    <footer class="p-y-64 bg-17191E">
        <div class="new-container">
            <div class="d-flex justify-content-between">
                <img src="<?php echo G5_IMG_URL; ?>/whitelogo.png" alt="" class="footer-img">
                <div class="d-flex">
                    <a class="text-white f-s-18" href="<?php echo get_eyoom_pretty_url('page','noemail'); ?>">카카오톡 채널추가</a>
                    <a class="text-white m-l-40 f-s-18" href="<?php echo get_eyoom_pretty_url('page','noemail'); ?>">상품후기</a>
                    <a class="text-white m-l-40 f-s-18" href="<?php echo G5_BBS_URL; ?>/qalist.php">1:1문의</a>
                    <a class="text-white m-l-40 f-s-18" href="<?php echo G5_BBS_URL; ?>/faq.php">FAQ</a>
                    <a class="text-white m-l-40 f-s-18" href="<?php echo get_eyoom_pretty_url('page','noemail'); ?>">공지사항</a>
                </div>
            </div>
            <div class="m-t-64">
                <div class="d-flex">
                    <p class="m-b-0 text-white f-s-14">CS CENTER 1522-2041</p>
                    <span class="text-606878 f-s-12 d-flex align-items-center p-x-8">|</span>
                    <p class="m-b-0 text-white f-s-14">평일 10:00 ~ 17:00 (점심 12:00 ~ 13:00)</p>
                </div>
                <div class="d-flex m-t-6">
                    <p class="m-b-0 text-9DA6BB f-s-14">soo@p2u.kr</p>
                    <span class="text-9DA6BB f-s-12 d-flex align-items-center p-x-8">|</span>
                    <p class="m-b-0 text-9DA6BB f-s-14">토요일, 일요일, 공휴일은 휴무입니다. 근무시간 이후 문의는 1:1 문의를 이용해주세요.</p>
                </div>
                <div class="d-flex m-t-20">
                    <p class="m-b-0 text-white f-s-14">주식회사 포인투유</p>
                    <span class="text-606878 f-s-12 d-flex align-items-center p-x-8">|</span>
                    <p class="m-b-0 text-white f-s-14">대표 : 최병호</p>
                </div>
                <div class="d-flex m-t-6">
                    <p class="m-b-0 text-9DA6BB f-s-14">soo@p2u.kr</p>
                    <span class="text-9DA6BB f-s-12 d-flex align-items-center p-x-8">|</span>
                ...
                <div class="d-flex m-t-20">
                    <p class="m-b-0 text-white f-s-14">Copyright © P2U :: 포인투유. All Rights Reserved</p>
                </div>
                <div class="d-flex m-t-48">
                    <a class="text-white f-s-18" href="<?php echo get_eyoom_pretty_url('page','provision'); ?>">이용약관</a>
                    <a class="text-white m-l-24 f-s-18" href="<?php echo get_eyoom_pretty_url('page','privacy'); ?>">개인정보처리방침</a>
                    <a class="text-white m-l-24 f-s-18" href="<?php echo get_eyoom_pretty_url('page','noemail'); ?>">이메일무단수집거부</a>
                </div>
            </div>
        </div>
    </footer>
